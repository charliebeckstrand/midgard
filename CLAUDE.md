...
- **`claude/preferences.md`** — User code-style and formatting preferences. **At the start of every session**, read this file and apply its conventions to all code written. If the user states a preference (e.g., ordering, naming, formatting), append it here. Create the file if it does not exist.
