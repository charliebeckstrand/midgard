...
3.1 Compose from `ui` first. It owns the components, design tokens, and recipes. Raw Tailwind for anything it covers is a defect. Need a reusable component it lacks? Add it to `ui`, don’t bury it in a feature. See REFERENCE.md.
