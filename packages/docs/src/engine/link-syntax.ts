...
// interleave references with prose. Pure string handling, no compiler
// dependency, so both the ts6 extractor and the browser chrome share this one
// copy — the serialize side and the parse side can never drift.
