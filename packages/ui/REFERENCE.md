...
- *Accessibility* — `useA11yScope` (base), `useA11yPanel`, `useA11yControl`, `useA11yDisclosure` (trigger/panel pairing), `useA11yRoving` (roving tabindex), `useA11yFocusReturn`, `useA11yAutoFocus`, `useA11yLiveRegion`, `useAriaIds`
