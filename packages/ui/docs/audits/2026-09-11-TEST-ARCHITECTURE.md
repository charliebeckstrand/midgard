...
**Four guards landed against the intermittent failure, and none of them moved it.** The body-residue gate, the failure forensics, the viewport restore and the singleton reset registry are all defensible on their own terms, and together they left the rate where they found it: seven failures in the forty-five runs after the first guard, against three in the twenty-three before. Twelve consecutive clean runs in the middle of that looked like a fix and were luck, which is the trap this rate sets for anyone measuring in short batches.
