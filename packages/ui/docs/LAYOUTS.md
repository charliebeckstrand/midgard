...
| Export | Summary |
|---|---|
| `SidebarLayout` | App shell, pinned to the viewport: a desktop sidebar (inline, or a hover-revealed floating sheet), a mobile drawer-and-navbar, and a density-aware content region. The sidebar sits on the start edge. |
