...
| `current` | Shared active-panel cascade for Tabs/Nav; the container animates height and child panels fade or unmount on value match. | `CurrentContext`, `useCurrent`, `CurrentContent`, `CurrentContents` |
