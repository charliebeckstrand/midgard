...
export type SwatchProps = SwatchVariants & {
	/**
	 * The hue on `currentColor`, one of:
	 *
	 * - a `kata/chart` palette slot name (`'blue'`, `'red'`, …), inked through its
	 *   CVD-validated `text-*` class;
	 * - a raw hex (`'#2563eb'`) or `oklch()` string, inked inline;
