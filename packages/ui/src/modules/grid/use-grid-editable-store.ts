...
import type { GridEditableSnapshot, GridEditableStore } from './grid-editable-context'
...
export function useGridEditableStore(snapshot: GridEditableSnapshot): GridEditableStore {
	...
	const storeRef = useRef<GridEditableStore | null>(null)
