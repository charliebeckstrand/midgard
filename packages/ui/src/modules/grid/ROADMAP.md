...
| Column header menu | Right-click sort + clear-sort + pin (Pin Left / Pin Right / Unpin) + auto-size + "Choose Columns" shipped via `contextMenu`; fold in filter/hide menu items as they land |
