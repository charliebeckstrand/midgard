...
**See also:** [`__benchmarks__/browser/README.md`](../../__benchmarks__/browser/README.md) (the competitive suite and its methodology) · [`index.ts`](index.ts) (public surface) · [`../../docs/MODULES.md`](../../../docs/MODULES.md). Residual feature work — the editing increments, cell/range selection, nested grouping, variable-height virtualization — is retired from this tracker; the editing design persists in [`../../docs/plans/2026-07-08-GRID-EDITING-PLAN.md`](../../../docs/plans/2026-07-08-GRID-EDITING-PLAN.md) (increments 1–5 and 8 shipped: triggers, cell scope, commit-and-move keys, commit on leave, async commit, and the new-row editor, an internal pinned slot rather than a public row-pinning primitive; the editing benches live in `grid-editing.bench.tsx`), and variable-height virtualization in [`../../docs/plans/2026-08-12-VARIABLE-HEIGHT-VIRTUALIZATION-PLAN.md`](../../../docs/plans/2026-08-12-VARIABLE-HEIGHT-VIRTUALIZATION-PLAN.md) (increment 3 shipped: under `virtualize`, the client-grouped and master-detail bodies window one measured item list each; manual grouping stays unwindowed; the benches live in `grid-window.bench.tsx`). Since #1269 the keyboard cursor walks the client-grouped and master-detail rows; manual grouping still stands it down.
