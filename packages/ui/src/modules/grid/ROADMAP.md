...
| Column header menu | Right-click sort + clear-sort + auto-size + "Choose Columns" shipped via `contextMenu`; column pinning ships declaratively (`pinned`); fold in filter/pin/hide menu items as they land |
