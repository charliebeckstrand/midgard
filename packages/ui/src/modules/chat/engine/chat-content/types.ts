/**
 * What a chat message holds: a `string` of prose, or a part list. A part list
 * holds prose beside embedded views and tool steps. Later increments add
 * attachments and citations (see the module ROADMAP §Backlog).
 */

/**
 * One block of prose, written as GitHub-flavored Markdown. A `content` string
 * normalizes to exactly one of these.
 */
 ...
 *
 * The discriminant is `kind`, which is what other unions in this package
 * read — `MapRouteFailure`, `QuerySummaryToken`, `CellTooltip`. It also
