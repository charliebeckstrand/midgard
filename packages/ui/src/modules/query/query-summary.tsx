 ...
 * operator that the field does not offer shows its built-in label, so `isEmpty`
 * on a `number` field reads `is Empty`. For a plain string (a `title`, an
 * aria-label, a log), reach for `formatQuerySummary`.
 */
