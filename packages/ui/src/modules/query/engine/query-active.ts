 ...
 * boolean. A tree of only blank rules reads as inactive. A freshly seeded or
 * fully cleared builder leaves such a tree behind. A filter affordance can
 * therefore reflect a real constraint, rather than the mere presence of a rule.
 *
