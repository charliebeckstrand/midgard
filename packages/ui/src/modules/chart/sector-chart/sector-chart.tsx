...
export function SectorChart<T>(props: SectorChartProps<T>) {
	...
	// The header band counts with the stacked legend, so a titled pie reserves its
	// lines the way a cartesian chart does.
	...
	// chartFramePolicy resolves the tier against the figure's `width / ratio` less
	// the header and legend rather than the measured remainder it would loop on.
