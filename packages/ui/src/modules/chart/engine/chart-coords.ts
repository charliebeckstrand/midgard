 ...
 * At ten thousand points those digits are the path string: hundreds of
 ...
 * size, so the rounding never shows. The string it produces is a fraction of
 * the size. An integer coordinate round-trips to its own digits
