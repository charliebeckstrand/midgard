 ...
 * applies to a series. A rule's hover therefore reads as a deliberate emphasis,
 * not a hit-target conflict with the marks under it.
 *
 ...
 * `AnimatePresence mode="wait"`. The outgoing generation therefore runs its
