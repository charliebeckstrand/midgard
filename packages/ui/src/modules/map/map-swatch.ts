 ...
 * readouts. The legend and the tooltip both key a swatch off a mark.
...
/**
 * The `Swatch` shape each mark shape reads out as:
 *
 * - a square for the geofence, the one mark that draws an area. A region takes
 *   it too, being an area though it is no overlay.
 * - a line for a route and a marker
 * - a circle for a point and for a set of them
 *
 * @internal
 */
