 ...
 * surface. Light at 5% zinc, dark at 5% white. Guarded so disabled
 * descendants don't accidentally light up. Consumed by the menu/option
 * item chrome (`hannou.item`) and any kata that wants the same wash.
 *
