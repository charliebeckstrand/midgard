 ...
 * translucent fill. There {@link tint} lands at the strength of the fill itself,
 * and the hover only repaints the rest state. This doubles the `omote.bg.tint`
 * such a surface sits on: 10% zinc on light, 20% white on dark. The hover
 * therefore reads as a step out of the surface in each mode.
 *
