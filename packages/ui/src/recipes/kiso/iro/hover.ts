...
export const hover = shades({
	zinc: 'not-disabled:hover:bg-zinc-500/15',
	red: 'not-disabled:hover:bg-red-500/15',
	amber: 'not-disabled:hover:bg-amber-500/15',
	green: 'not-disabled:hover:bg-green-500/15',
	blue: 'not-disabled:hover:bg-blue-500/15',
})
