 ...
 * half of focus behavior jsdom can observe. Each case (`cases/focus.tsx`)
 ...
 * jsdom honors. Menu never moves focus off its trigger in the first place, so
...
describe('a11y focus: restoration (dropdown family)', () => {
	...
	// same direct-focus path as Menu; jsdom honors it. The test closes via
