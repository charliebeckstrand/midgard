...
import { useQueryTree } from '../../modules/query/use-query-tree'
...
describe('useQueryTree', () => {
	...
	it('supports a controlled value', () => {
		...
		const { result } = renderHook(() => useQueryTree({ fields, value }))
