...
// `stubMatchMedia` is importable for a per-test predicate.
//
...
// by ~360 test files, and a re-export evaluates ./axe in every one of them,
...
export { hasIntermediate, sampleHeights } from './sample-heights'
export { allBySlot, bySlot, getAllSlots, getSlot } from './slot-queries'
export { stickyInset } from './sticky-inset'
export { stubMatchMedia } from './stub-match-media'
export { withFakeTime } from './with-fake-time'
