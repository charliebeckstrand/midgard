 ...
 * union, and both resolve it through here. The two can therefore never disagree
 * about which ratios are valid.
 *
 ...
 * frame would be an invalid CSS `aspect-ratio` the browser drops. It would also
 * be a negative `viewBox` height that stops the drawing rendering.
 */
