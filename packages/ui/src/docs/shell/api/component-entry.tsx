...
import type { ComponentApi, PassThrough, PropDef } from '../../engine/extractor'
...
/**
 * One component's reference body: description, Props and Events sections split
 * on the `on[A-Z]` handler convention, and the pass-through footer naming the
 * inherited DOM elements.
 */
