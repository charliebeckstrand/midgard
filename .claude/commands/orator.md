...
- **Use `orator`** for any surface where idiomatic convention is the bar. Code comments, docstrings, commit and PR copy, READMEs, design docs, release notes, ad-hoc messages.
